...
### Frontend (Vue.js)
1. Rendez-vous dans le dossier du frontend :
...
- Stockage sécurisé des tokens et nettoyage automatique de l'ensemble des données utilisateur en local storage (token, user_email, rôle) en cas d'interception d'une réponse 401 Unauthorized.

- **Contrôle d'accès :**
  Vérification systématique de la propriété d'une structure (isOwner) combinée aux rôles côté back et front pour interdire toute modification non autorisée.

-**Accessibilité Numérique :** 
Respect des bonnes pratiques d'ergonomie et d'accessibilité (ARIA) pour garantir une navigation fluide aux utilisateurs en situation de handicap (lecteurs d'écran, navigation au clavier).
